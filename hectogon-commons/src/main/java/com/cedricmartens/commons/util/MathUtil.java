 ...
 * @author Nathan Sweet and Cedric Martens*/
public class MathUtil
{
    ...
    /**
     * Converts a radian angle into a fuzzy direction
     * @param direction A radian angle
     * @return a fuzzy direction resulting from the radian angle
     */
    static public FuzzyDirection getFuzzyDirection(float direction)
    {
        ...
        int val = (int) ((direction - Math.PI/4)/(Math.PI/2));
        return FuzzyDirection.values()[val + 1];
    }
}